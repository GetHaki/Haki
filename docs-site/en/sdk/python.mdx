...
Inside the Haki repository, the SDK is a **local editable** dependency
(`pyproject.toml`, `[tool.uv.sources]`): `uv sync` at the repo root
installs it automatically, alongside the API itself.

Used outside the repository (your own project):
