...
Remesuré le 10 août 2026 — le tableau ci-dessous remplace une mesure
antérieure dont les chiffres avaient dérivé (voir l'historique git du
script pour les anciennes valeurs si besoin).
...
Ce chiffre de 249 ms (p95, 10 000 faits) est la seule mesure de performance
